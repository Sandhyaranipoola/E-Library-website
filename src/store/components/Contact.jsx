...
const Contact = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    ...
    <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      <h1 className="text-gray-900 text-lg mb-1 font-medium title-font">Feedback</h1>
      <p className="leading-relaxed mb-5 text-gray-600">We are great to hear from you. Let us know your experience about our website.</p>
